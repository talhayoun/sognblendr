...
import { Form, Input, Cascader, Select, Checkbox, AutoComplete, message } from "antd";
import GreenButton from "../../components/styled-components/StyledButtons/GreenButton/GreenButton";
import { UserOutlined, MailOutlined, FacebookOutlined, PhoneOutlined } from '@ant-design/icons';
import { createDjAccount } from "../../apis/dj";
...
const CreateDjAccount = () => {
  ...
  const onFinish = async (values) => {
    ...
    const response = await createDjAccount(values);
    if (response.data.message || response.data.djid) {
  ...
  return (
    ...
    >
      ...
      <Form.Item name="facebookId" label="Facebook ID">
        <Input style={{ borderRadius: "20px" }} prefix={<FacebookOutlined />} />
      </Form.Item>

      <Form.Item name="residence" label="Location">
